            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="section-title">
						...
						<form action="/SimpleProjectLogin/login" onsubmit='return(validation())' name="loginForm" id="loginForm"  method="post">
							 <div class="form-group">
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="location-info">
                            ...
                            <p class="white"><span aria-hidden="true" class="fa fa-phone"></span>Phone: 7507930301</p>
                            <p class="white"><span aria-hidden="true" class="fa fa-envelope"></span>Email: <a href="" class="link-dec">ampledoftech@gmail.com</a></p>
                        </div>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="row">
                ...
                <a href="Manager">Manager</a>
                    ...
                    <div class="credits">
                        ...
                        Designed by <a href="https://bootstrapmade.com/">Ample Softech Systems Pvt. Ltd</a>
                    </div>
                </div>
